...
class DebugViewController: UIViewController, SerialController, MediaController {
    let knownColors = [
        UIColor.redColor(),
        UIColor.blueColor(),
        UIColor.greenColor(),
    ...
    lazy private(set) var nextViewController: UIViewController? = DebugViewController()
    lazy private(set) var previousViewController: UIViewController? = DebugViewController()
